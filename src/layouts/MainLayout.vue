<template>
  <q-layout class="overflow-hidden bg-background">
    <q-page-container class="">
      <router-view />
    </q-page-container>

  </q-layout>
  <svg class="absolute bottom-0 w-full z-[0] h-auto" width="1440" height="111" viewBox="0 0 1440 111" fill="none"
